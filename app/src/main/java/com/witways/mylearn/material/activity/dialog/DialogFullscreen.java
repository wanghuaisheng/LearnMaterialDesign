package com.witways.mylearn.material.activity.dialog;
...
import com.witways.mylearn.material.fragment.DialogFullscreenFragment;
import com.witways.mylearn.material.model.Event;
...
public class DialogFullscreen extends AppCompatActivity {
    ...
    private void displayDataResult(Event event) {
        ...
        ((TextView) findViewById(R.id.tv_allday)).setText(event.isAllDay.toString());
