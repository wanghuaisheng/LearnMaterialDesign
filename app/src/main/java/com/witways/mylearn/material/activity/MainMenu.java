package com.witways.mylearn.material.activity;
...
import com.witways.mylearn.material.activity.bottomnavigation.BottomNavigationBasic;
import com.witways.mylearn.material.activity.bottomnavigation.BottomNavigationDark;
import com.witways.mylearn.material.activity.bottomnavigation.BottomNavigationIcon;
import com.witways.mylearn.material.activity.bottomnavigation.BottomNavigationLight;
import com.witways.mylearn.material.activity.bottomnavigation.BottomNavigationMapBlue;
import com.witways.mylearn.material.activity.bottomnavigation.BottomNavigationPrimary;
import com.witways.mylearn.material.activity.bottomnavigation.BottomNavigationShifting;
import com.witways.mylearn.material.activity.bottomsheet.BottomSheetBasic;
import com.witways.mylearn.material.activity.bottomsheet.BottomSheetFloating;
import com.witways.mylearn.material.activity.bottomsheet.BottomSheetFull;
import com.witways.mylearn.material.activity.bottomsheet.BottomSheetList;
import com.witways.mylearn.material.activity.bottomsheet.BottomSheetMap;
import com.witways.mylearn.material.activity.button.ButtonBasic;
import com.witways.mylearn.material.activity.button.ButtonInUtilities;
import com.witways.mylearn.material.activity.button.FabMiddle;
import com.witways.mylearn.material.activity.button.FabMore;
import com.witways.mylearn.material.activity.button.FabMoreText;
import com.witways.mylearn.material.activity.card.CardBasic;
import com.witways.mylearn.material.activity.card.CardOverlap;
import com.witways.mylearn.material.activity.card.CardTimeline;
import com.witways.mylearn.material.activity.card.CardWizard;
import com.witways.mylearn.material.activity.card.CardWizardLight;
import com.witways.mylearn.material.activity.card.CardWizardOverlap;
import com.witways.mylearn.material.activity.chip.ChipBasic;
import com.witways.mylearn.material.activity.chip.ChipTag;
import com.witways.mylearn.material.activity.dashboard.DashboardFlight;
import com.witways.mylearn.material.activity.dashboard.DashboardGridFab;
import com.witways.mylearn.material.activity.dashboard.DashboardPayBill;
import com.witways.mylearn.material.activity.dashboard.DashboardStatistics;
import com.witways.mylearn.material.activity.dialog.DialogAddPost;
import com.witways.mylearn.material.activity.dialog.DialogAddReview;
import com.witways.mylearn.material.activity.dialog.DialogBasic;
import com.witways.mylearn.material.activity.dialog.DialogCustom;
import com.witways.mylearn.material.activity.dialog.DialogCustomDark;
import com.witways.mylearn.material.activity.dialog.DialogCustomInfo;
import com.witways.mylearn.material.activity.dialog.DialogCustomLight;
import com.witways.mylearn.material.activity.dialog.DialogCustomWarning;
import com.witways.mylearn.material.activity.dialog.DialogFullscreen;
import com.witways.mylearn.material.activity.expansionpanel.ExpansionPanelBasic;
import com.witways.mylearn.material.activity.expansionpanel.ExpansionPanelInvoice;
import com.witways.mylearn.material.activity.expansionpanel.ExpansionPanelTicket;
import com.witways.mylearn.material.activity.form.FormLogin;
import com.witways.mylearn.material.activity.form.FormProfileData;
import com.witways.mylearn.material.activity.form.FormSignUp;
import com.witways.mylearn.material.activity.form.FormTextArea;
import com.witways.mylearn.material.activity.form.FormWithIcon;
import com.witways.mylearn.material.activity.gridlist.GridAlbums;
import com.witways.mylearn.material.activity.gridlist.GridBasic;
import com.witways.mylearn.material.activity.gridlist.GridCaller;
import com.witways.mylearn.material.activity.gridlist.GridSectioned;
import com.witways.mylearn.material.activity.gridlist.GridSingleLine;
import com.witways.mylearn.material.activity.gridlist.GridTwoLine;
import com.witways.mylearn.material.activity.list.ListAnimation;
import com.witways.mylearn.material.activity.list.ListBasic;
import com.witways.mylearn.material.activity.list.ListDrag;
import com.witways.mylearn.material.activity.list.ListExpand;
import com.witways.mylearn.material.activity.list.ListMultiSelection;
import com.witways.mylearn.material.activity.list.ListSectioned;
import com.witways.mylearn.material.activity.list.ListSwipe;
import com.witways.mylearn.material.activity.login.LoginCardLight;
import com.witways.mylearn.material.activity.login.LoginCardOverlap;
import com.witways.mylearn.material.activity.login.LoginImageTeal;
import com.witways.mylearn.material.activity.login.LoginSimpleDark;
import com.witways.mylearn.material.activity.login.LoginSimpleGreen;
import com.witways.mylearn.material.activity.login.LoginSimpleLight;
import com.witways.mylearn.material.activity.menu.MenuDrawerMail;
import com.witways.mylearn.material.activity.menu.MenuDrawerNews;
import com.witways.mylearn.material.activity.menu.MenuDrawerNoIcon;
import com.witways.mylearn.material.activity.menu.MenuDrawerSimpleDark;
import com.witways.mylearn.material.activity.menu.MenuDrawerSimpleLight;
import com.witways.mylearn.material.activity.menu.MenuOverflowList;
import com.witways.mylearn.material.activity.menu.MenuOverflowToolbar;
import com.witways.mylearn.material.activity.noitem.NoItemArchived;
import com.witways.mylearn.material.activity.noitem.NoItemBgCactus;
import com.witways.mylearn.material.activity.noitem.NoItemBgCity;
import com.witways.mylearn.material.activity.noitem.NoItemInternetIcon;
import com.witways.mylearn.material.activity.noitem.NoItemInternetImage;
import com.witways.mylearn.material.activity.noitem.NoItemSearch;
import com.witways.mylearn.material.activity.noitem.NoItemTabs;
import com.witways.mylearn.material.activity.payment.PaymentCardCollections;
import com.witways.mylearn.material.activity.payment.PaymentCardDetails;
import com.witways.mylearn.material.activity.payment.PaymentForm;
import com.witways.mylearn.material.activity.payment.PaymentProfile;
import com.witways.mylearn.material.activity.payment.PaymentSuccessDialog;
import com.witways.mylearn.material.activity.picker.PickerColor;
import com.witways.mylearn.material.activity.picker.PickerDateDark;
import com.witways.mylearn.material.activity.picker.PickerDateLight;
import com.witways.mylearn.material.activity.picker.PickerLocation;
import com.witways.mylearn.material.activity.picker.PickerTimeDark;
import com.witways.mylearn.material.activity.picker.PickerTimeLight;
import com.witways.mylearn.material.activity.player.PlayerMusicAlbumCircle;
import com.witways.mylearn.material.activity.player.PlayerMusicAlbumDark;
import com.witways.mylearn.material.activity.player.PlayerMusicAlbumGrid;
import com.witways.mylearn.material.activity.player.PlayerMusicAlbumSimple;
import com.witways.mylearn.material.activity.player.PlayerMusicBasic;
import com.witways.mylearn.material.activity.player.PlayerMusicGenre;
import com.witways.mylearn.material.activity.player.PlayerMusicGenreImage;
import com.witways.mylearn.material.activity.player.PlayerMusicGenreLight;
import com.witways.mylearn.material.activity.player.PlayerMusicLight;
import com.witways.mylearn.material.activity.player.PlayerMusicSongList;
import com.witways.mylearn.material.activity.player.PlayerMusicTabs;
import com.witways.mylearn.material.activity.player.PlayerMusicTabsIcon;
import com.witways.mylearn.material.activity.profile.ProfileBlueAppbar;
import com.witways.mylearn.material.activity.profile.ProfileCardList;
import com.witways.mylearn.material.activity.profile.ProfileDrawerImage;
import com.witways.mylearn.material.activity.profile.ProfileDrawerSimple;
import com.witways.mylearn.material.activity.profile.ProfileFabMenu;
import com.witways.mylearn.material.activity.profile.ProfileGallery;
import com.witways.mylearn.material.activity.profile.ProfileGalleryTwo;
import com.witways.mylearn.material.activity.profile.ProfileImageAppbar;
import com.witways.mylearn.material.activity.profile.ProfilePolygon;
import com.witways.mylearn.material.activity.profile.ProfilePurple;
import com.witways.mylearn.material.activity.profile.ProfileRed;
import com.witways.mylearn.material.activity.progressactivity.ProgressBasic;
import com.witways.mylearn.material.activity.progressactivity.ProgressCircleCenter;
import com.witways.mylearn.material.activity.progressactivity.ProgressDotsBounce;
import com.witways.mylearn.material.activity.progressactivity.ProgressDotsFade;
import com.witways.mylearn.material.activity.progressactivity.ProgressDotsGrow;
import com.witways.mylearn.material.activity.progressactivity.ProgressLinearCenter;
import com.witways.mylearn.material.activity.progressactivity.ProgressLinearTop;
import com.witways.mylearn.material.activity.progressactivity.ProgressOnScroll;
import com.witways.mylearn.material.activity.progressactivity.ProgressPullRefresh;
import com.witways.mylearn.material.activity.search.SearchCity;
import com.witways.mylearn.material.activity.search.SearchHistoryCard;
import com.witways.mylearn.material.activity.search.SearchPrimary;
import com.witways.mylearn.material.activity.search.SearchPrimaryBg;
import com.witways.mylearn.material.activity.search.SearchStore;
import com.witways.mylearn.material.activity.search.SearchToolbarDark;
import com.witways.mylearn.material.activity.search.SearchToolbarLight;
import com.witways.mylearn.material.activity.settings.SettingFlat;
import com.witways.mylearn.material.activity.settings.SettingProfile;
import com.witways.mylearn.material.activity.settings.SettingProfileLight;
import com.witways.mylearn.material.activity.settings.SettingSectioned;
import com.witways.mylearn.material.activity.shopping.ShoppingCategoryCard;
import com.witways.mylearn.material.activity.shopping.ShoppingCategoryImage;
import com.witways.mylearn.material.activity.shopping.ShoppingCategoryList;
import com.witways.mylearn.material.activity.shopping.ShoppingCheckoutCard;
import com.witways.mylearn.material.activity.shopping.ShoppingProductAdvDetails;
import com.witways.mylearn.material.activity.shopping.ShoppingProductDetails;
import com.witways.mylearn.material.activity.shopping.ShoppingProductGrid;
import com.witways.mylearn.material.activity.shopping.ShoppingSubCategoryTabs;
import com.witways.mylearn.material.activity.slider.SliderColorPicker;
import com.witways.mylearn.material.activity.slider.SliderDark;
import com.witways.mylearn.material.activity.slider.SliderLight;
import com.witways.mylearn.material.activity.sliderimage.SliderImageCard;
import com.witways.mylearn.material.activity.sliderimage.SliderImageCardAuto;
import com.witways.mylearn.material.activity.sliderimage.SliderImageHeader;
import com.witways.mylearn.material.activity.sliderimage.SliderImageHeaderAuto;
import com.witways.mylearn.material.activity.snackbartoast.SnackbarAndFab;
import com.witways.mylearn.material.activity.snackbartoast.SnackbarToastBasic;
import com.witways.mylearn.material.activity.stepper.StepperDots;
import com.witways.mylearn.material.activity.stepper.StepperProgress;
import com.witways.mylearn.material.activity.stepper.StepperText;
import com.witways.mylearn.material.activity.stepper.StepperVertical;
import com.witways.mylearn.material.activity.stepper.StepperWizardColor;
import com.witways.mylearn.material.activity.stepper.StepperWizardLight;
import com.witways.mylearn.material.activity.tabs.TabsBasic;
import com.witways.mylearn.material.activity.tabs.TabsDark;
import com.witways.mylearn.material.activity.tabs.TabsIcon;
import com.witways.mylearn.material.activity.tabs.TabsIconLight;
import com.witways.mylearn.material.activity.tabs.TabsIconStack;
import com.witways.mylearn.material.activity.tabs.TabsLight;
import com.witways.mylearn.material.activity.tabs.TabsRound;
import com.witways.mylearn.material.activity.tabs.TabsScroll;
import com.witways.mylearn.material.activity.tabs.TabsStore;
import com.witways.mylearn.material.activity.tabs.TabsTextIcon;
import com.witways.mylearn.material.activity.timeline.TimelineDotCard;
import com.witways.mylearn.material.activity.timeline.TimelineFeed;
import com.witways.mylearn.material.activity.timeline.TimelinePath;
import com.witways.mylearn.material.activity.timeline.TimelineSimple;
import com.witways.mylearn.material.activity.timeline.TimelineTwitter;
import com.witways.mylearn.material.activity.toolbar.ToolbarBasic;
import com.witways.mylearn.material.activity.toolbar.ToolbarCollapse;
import com.witways.mylearn.material.activity.toolbar.ToolbarCollapsePin;
import com.witways.mylearn.material.activity.toolbar.ToolbarDark;
import com.witways.mylearn.material.activity.toolbar.ToolbarLight;
import com.witways.mylearn.material.activity.verification.VerificationBlue;
import com.witways.mylearn.material.activity.verification.VerificationCode;
import com.witways.mylearn.material.activity.verification.VerificationHeader;
import com.witways.mylearn.material.activity.verification.VerificationImage;
import com.witways.mylearn.material.activity.verification.VerificationOrange;
import com.witways.mylearn.material.activity.verification.VerificationPhone;
import com.witways.mylearn.material.activity.whs.TestOne;
import com.witways.mylearn.material.adapter.ExpandableRecyclerAdapter;
import com.witways.mylearn.material.adapter.MainMenuAdapter;
...
public class MainMenu extends AppCompatActivity {
    ...
    private List<MainMenuAdapter.ListItem> generateMenuItems() {
        ...
        items.add(new MainMenuAdapter.ListItem(306, "Fab按钮", -1, MenuType.SUB_HEADER));
        ...
        items.add(new MainMenuAdapter.ListItem(29000, "仪表盘", R.drawable.ic_event_seat, MenuType.HEADER));
        items.add(new MainMenuAdapter.ListItem(29001, "Grid Fab", -1, MenuType.SUB_HEADER));
        items.add(new MainMenuAdapter.ListItem(29002, "分析", -1, MenuType.SUB_HEADER));
        items.add(new MainMenuAdapter.ListItem(29003, "Pay Bill", -1, MenuType.SUB_HEADER));
        items.add(new MainMenuAdapter.ListItem(29004, "航班", -1, MenuType.SUB_HEADER));

        items.add(new MainMenuAdapter.ListItem(-1, "其它", -1, MenuType.DIVIDER));
        items.add(new MainMenuAdapter.ListItem(1, "关于", R.drawable.ic_error_outline, MenuType.NORMAL));
        items.add(new MainMenuAdapter.ListItem(2, "测试", R.drawable.ic_event, MenuType.NORMAL));
    ...
    private void showDialogAbout() {
        ...
        ((AppCompatButton) dialog.findViewById(R.id.bt_getcode)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://www.witsway.cn"));
                startActivity(i);
            }
        });
